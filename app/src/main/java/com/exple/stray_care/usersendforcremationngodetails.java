...
public class usersendforcremationngodetails extends AppCompatActivity {
    ...
    int position;
    String url="https://stray-care.000webhostapp.com/usersendforcremationngodata.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_usersendforcremationngodetails);
    ...
    public void insertcremationdata(View view) {
        ...
        if (tvanitype.getText().toString().equals("")) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    Toast.makeText(usersendforcremationngodetails.this, response, Toast.LENGTH_SHORT).show();
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    progressDialog.dismiss();
                    Toast.makeText(usersendforcremationngodetails.this, error.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(usersendforcremationngodetails.this);
